...
const SKILL_OBJECTIVES = [
  { id: 'obj-1', description: 'Role Appropriateness - Select roles that match team member strengths', weight: 0.35 },
  { id: 'obj-2', description: 'Reasoning and Justification - Explain why each role assignment makes sense', weight: 0.4 },
  { id: 'obj-3', description: 'Collaborative Thinking - Consider team dynamics and complementary skills', weight: 0.25 },
];
...
export default function Collaboration() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const context: LessonEvaluationContext = {
        lessonId: 4,
        skillId: 4, // Collaboration skill
        difficulty: 'medium',
        objectives: SKILL_OBJECTIVES,
        question: 'Assign roles for a group project and explain why you chose them.\nRoles: Researcher, Organizer, Executor.',
        studentResponse: answer,
      };

      // Actualizar mensaje mientras procesa
      setLoadingMessage('Analizando tu colaboración...');
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.lessonTitle}>Lesson 4: Collaboration</Text>
      <Text style={styles.progress}>50% Complete</Text>
      <View style={styles.progressBar}>
        <View style={{ ...styles.progressFill, width: '50%' }} />
      </View>
      <View style={styles.challengeBox}>
        <Text style={styles.challengeTitle}>Challenge 1: Team Roles</Text>
        <Text style={styles.challengeDescription}>
          Assign roles for a group project and explain why you chose them.
        </Text>
